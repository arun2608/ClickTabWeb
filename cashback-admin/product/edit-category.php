		...
		<div class="right_col" role="main" style="height: 600px;">
          ...
          <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Category<small id="product-msg"></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
				  <?php 
					 $categoryData = $adminDao->categoryById($_REQUEST['id']);?>
                    <form class="form-horizontal form-label-left frm" >
					<input type="hidden" name="action_type" value="update-category">
          <input type="hidden" name="id" value="<?php echo $categoryData->Id;?>">
					<input type="hidden" name="type" value="1">
				
					<div class="form-group col-md-4">
                      <label>Category</label>
                       <input type='text' name='category' class="form-control" placeholder='Enter Category' value="<?php echo $categoryData->Category;?>"/>
					   <span class='message' id='msgcategory' style='display:none;'>&nbsp;</span>
                    </div>
					<div class="form-group col-md-4">
                        <label>Banner <img style="width:20px;" src="<?php echo $imageUrl."category/".$categoryData->Banner;?>"/></label>
                        <input id="file_1" type="file" name="banner" class="form-control col-md-7 col-xs-12"  accept=".jpeg,.jpg,.png,.webp">                                                  
                    </div>
					<div class="form-group col-md-4">
                        <label>Category Image <img style="width:20px;" src="<?php echo $imageUrl."category/".$categoryData->CategoryImage;?>"/></label>
					...
					<div class="form-group col-md-2 pull-right">
						<label>&nbsp;</label>
						<button type='button' id="authenticateCategory" class="form-control btn btn-success">Update Category</button>
					</div>

		...
		<div class="right_col" role="main" style="height: 600px;">
          ...
          <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Create Brand<small id="product-msg"></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">

                    <form class="form-horizontal form-label-left frm" >
					<input type="hidden" name="action_type" value="create-brand">
					...
					<div class="form-group col-md-2 pull-right">
						<label>&nbsp;</label>
						<button type='button' id="authenticateBrand" class="form-control btn btn-success">Save Brand</button>
					</div>

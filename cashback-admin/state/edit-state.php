        ...
        <div class="right_col" role="main" >
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit State<small id="validate-msg"></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
					<?php 
						$stateData = $adminDao->stateById($_REQUEST['id']);?>
                    <form id="state-frm" class="form-horizontal form-label-left">
                      <input type="hidden" name="action_type" value="update-state">
					  <input type="hidden" name="id" value="<?php echo $stateData->Id;?>">

					  <div class="col-md-3 form-group">
                        <label>State</label>
                        <input type='text' name="state" class="form-control col-md-7 col-xs-12" placeholder="Enter state" value="<?php echo $stateData->State;?>">
						<div class="clearfix"></div>

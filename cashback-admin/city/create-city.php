        ...
        <div class="right_col" role="main" >
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Create City<small id="validate-msg"></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="city-frm" class="form-horizontal form-label-left">
                      <input type="hidden" name="action_type" value="create-city">
                      
					  
					  <div class="col-md-3 form-group">
                        <label>Location</label>
                        <select name="state" class="form-control col-md-7 col-xs-12">
					  ...
					  <div class="col-md-3 form-group">
                        <label>City</label>
                        <input type='text' name="city" class="form-control col-md-7 col-xs-12" placeholder="Enter city">
						<div class="clearfix"></div>

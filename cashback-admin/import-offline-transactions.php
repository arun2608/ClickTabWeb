        ...
        <div class="right_col" role="main" >
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Import Offline Transaction<small id="validate-msg"></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="area-frm" class="form-horizontal form-label-left" action="<?php echo $siteUrl;?>controller/AdminController.php" method="post" enctype="multipart/form-data">
                      <input type="hidden" name="action_type" value="import-offline-transaction">
                      
					  <div class="col-md-3 form-group">
                        <label>Import Files  <a href="<?=$siteUrl?>import-offline-report.csv" style="color:red">Download Sample Excel</a></label>
